...
- Esta atividade envolve alguma manipulação de Strings. Logo, pode ser necessário pesquisar métodos da classe String que possam te ajudar. Pesquise na API. O livro Java Como Programar também tem um capítulo tratando apenas da classe String e dos seus métodos.
